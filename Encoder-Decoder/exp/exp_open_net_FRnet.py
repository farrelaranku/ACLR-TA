...
from utils.slowloss import SlowLearnerLoss, ssl_loss, ssl_loss_v2, BarlowTwins
...
class Exp_Main_DualmodE3K_FRnet(Exp_Basic):
    ...
    def train(self, setting):
        ...
        var_adapt_clr = {
            ...
            'max_lr': self.args.learning_rate * 20,
            'step_size': (((self.args.learning_rate * 20) - (self.args.learning_rate/20)) / train_steps),
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if (self.args.use_slow_learner):
                    ...
                    if(need_update):
                        ...
                        print('need update slow and fast parameter')
                        if self.args.use_amp:
                            scaler.scale(loss).backward()
                            scaler.step(slow_model_optim)
                            scaler.step(model_optim)

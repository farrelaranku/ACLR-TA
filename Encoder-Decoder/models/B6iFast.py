...
import random
from models import Informer, Autoformer, FRNet
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.models = nn.ModuleList([FRNet.Model(configs).float().cuda() for i in range(self.num_models)])

        print("[CREATE] " +str(self.num_models)+" learners of FRNet")
...
# 
    ...
    def forward_1learner(self, x_enc, x_mark_enc=None, x_dec=None, x_mark_dec=None,

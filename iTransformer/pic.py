...
image1 = Image.open("visualize\iTransformer_ValLoss_ETTm2_96_96.png")
image2 = Image.open("visualize\iTransformer_ValLoss_ETTm2_96_192.png")
image3 = Image.open("visualize\iTransformer_ValLoss_ETTm2_96_336.png")
image4 = Image.open("visualize\iTransformer_ValLoss_ETTm2_96_720.png")
...
grid_image.show()
grid_image.save("./visualize/iTrans_Valloss_ETTm2.png")
